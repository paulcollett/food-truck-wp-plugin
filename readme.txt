...
3. Click on the new menu item "Locations & Dates" to manage your locations, and access shortcodes
4. Add the shortcodes to any page / post / template, or add the widget to easily display
...
* Admin fix for address or name that is just a number
...
* Initial step to improve performance of map location data

= 1.0.0 =
* Locations & Times with Map & Widget Support
